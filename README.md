...
Finally, import the newly created `.scss` file instead of the default Bootstrap `.css` in the beginning of your `src/Footer.js` file, for example:
...
following in their [`src/Footer.js`](src/Footer.js) file:
...
- If the watcher doesn’t see a file called `Footer.js` and you’re referencing it by the folder name, you [need to restart the watcher](https://github.com/facebook/create-react-app/issues/1164) due to a Webpack bug.
